...
export const ORDER_PAY_COD_REQUEST = 'ORDER_PAY_COD_REQUEST';
export const ORDER_PAY_COD_SUCCESS = 'ORDER_PAY_COD_SUCCESS';
export const ORDER_PAY_COD_FAIL = 'ORDER_PAY_COD_FAIL';
export const ORDER_PAY_COD_RESET = 'ORDER_PAY_COD_RESET';
